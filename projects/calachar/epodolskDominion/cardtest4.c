...
int main (int argc, char** argv) {
	...
	printf("==========\n\n");
	printf("Card Test 4: Great Hall Function Test\n");
	printf("==========\n\n");

	initializeGame(2, k, atoi(argv[1]), &G);
	
	
	printf("Adding adding Great Hall card to player 0's hand.\n");
	...
	printf("\n");
	printf("==Playing a Great Hall card.==\n");
	...
	if(scoreFor(0, &G) != 4){
		printf("VICTORY POINT TEST FAILED\n");
	}
	else
	{ printf("VICTORY POINT TEST SUCCESSFUL\n");}
